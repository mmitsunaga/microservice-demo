...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterKafkaServiceConfigData TwitterKafkaServiceConfigData,
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterKafkaServiceConfigData.getTwitterV2BaseUrl());
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterKafkaServiceConfigData.getTwitterV2RulesBaseUrl());
